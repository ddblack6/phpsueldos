...
// Add some data
/*
 * Recibimos por post los objetos de html y realizamos la consulta dependiendo de los datos
 */
if  (empty($_POST['fuente'])){$choice=0;}else{$choice=$_POST['fuente'];}
...
header('Content-Disposition: attachment;filename="ResumenExcelFecha.xls"');
