...
?>
    ...
    <body>
        ...
        <div class='clearfix'></div>
          ...
          <a href="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/informes/InformeSueldoF10.php"><img src="img/boton_pdf_descarga.png" title="Enviar a PDF" style="position:center; bottom: 50px; left: 6%;" /></a>
          <a href="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/excel/InformeExcelF10.php"><img src="img/btnexcel.jpg" title="Enviar a Excel" style="position:absolute; bottom: 50px; left: 95%;" /></a>
          </div> 
</body>
