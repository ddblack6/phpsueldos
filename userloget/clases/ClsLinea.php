    ...
    <body>
          ...
          if  (empty($_POST['txtLinea'])){$descripcion=0;}else{ $descripcion = $_POST['txtLinea'];}
           ...
           if ($var==1){
			...
			alert("Esta Linea ya existe. Intente Ingresar otra Linea..");
			 window.location="http://localhost/app/phpsueldosuserloget/FrmLineaNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://localhost/app/phpsueldosuserloget/FrmLineaNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
            conexionlocal();
                ...
                //ejecucion del query
                $ejecucion = pg_query($query)or die('Error al realizar la carga');
                header("Refresh:0; url=http://localhost/app/phpsueldosuserloget/FrmLineaModif.php");
            }
       //
        ?>
    </body>
