...
<html>
    ...
    <body>
          ...
          if  (empty($_POST['txtdescripcion'])){$descripcion=0;}else{ $descripcion = $_POST['txtdescripcion'];}
           ...
           if ($var==1){
			...
			alert("El cargo ya existe. Intente ingresar otro Cargo");
			 window.location="http://192.168.0.99/web/phpsueldos2015/userloget/FrmCargoNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://192.168.0.99/web/phpsueldos2015/userloget/FrmCargoNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                //ejecucion del query
                $ejecucion = pg_query($query)or die('Error al realizar la carga');
                header("Refresh:0; url=http://192.168.0.99/web/phpsueldos2015/userloget/FrmCargoModif.php");
            }
       //
        ?>
    </body>
