    ...
    <body>
          ...
          if  (empty($_POST['txtOrganismo'])){$descripcion=0;}else{ $descripcion = $_POST['txtOrganismo'];}
           ...
           if ($var==1){
			...
			alert("El Organismo ya existe. Intente Ingresar otro Organismo..");
			 window.location="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
            conexionlocal();
                ...
                //ejecucion del query
                $ejecucion = pg_query($query)or die('Error al realizar la carga');
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoModif.php");
            }
       //
        ?>
    </body>
