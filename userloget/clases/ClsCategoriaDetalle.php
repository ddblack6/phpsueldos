...
<html>
    ...
    <body>
          ...
          $database = 'salario';
           ...
           if ($var==1){
			...
			alert("El detalle ya existe. Intente Ingresar otro Detalle de Categoria..");
			 window.location="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmCategoriaDetNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmCategoriaDetNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                $codigo=0;
                $var=0;
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmCategoriaDetModif.php");
            }
       //
        ?>
    </body>
