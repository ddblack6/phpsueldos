...
<html>
    ...
    <body>
          ...
          $database = 'salario';
           ...
           if ($var==1){
			...
			alert("El detalle ya existe. Intente Ingresar otro Detalle de Categoria..");
			 window.location="http://localhost/app/phpsueldosuserloget/FrmCategoriaDetNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://localhost/app/phpsueldosuserloget/FrmCategoriaDetNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                $codigo=0;
                $var=0;
                header("Refresh:0; url=http://localhost/app/phpsueldosuserloget/FrmCategoriaDetModif.php");
            }
       //
        ?>
    </body>
