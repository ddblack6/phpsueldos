...
<html>
    ...
    <body>
          ...
          $database = 'salario'; 
           ...
           if ($var==1){
			...
			alert("El Detalle de Organismo ya existe. Intente Ingresar otro Detalle..");
			 window.location="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoDetNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoDetNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                $codigo=0;
                $var=0;
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmOrganismoDetModif.php");
            }
       //
        ?>
    </body>
