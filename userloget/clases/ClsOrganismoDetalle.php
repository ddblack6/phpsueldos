...
<html>
    ...
    <body>
          ...
          $database = 'salario'; 
           ...
           if ($var==1){
			...
			alert("El Detalle de Organismo ya existe. Intente Ingresar otro Detalle..");
			 window.location="http://192.168.0.99/web/phpsueldos2015/userloget/FrmOrganismoDetNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://192.168.0.99/web/phpsueldos2015/userloget/FrmOrganismoDetNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                $codigo=0;
                $var=0;
                header("Refresh:0; url=http://192.168.0.99/web/phpsueldos2015/userloget/FrmOrganismoDetModif.php");
            }
       //
        ?>
    </body>
