...
<html>
    ...
    <body>
          ...
          $database = 'salario';
           ...
           if ($var==1){
			...
			alert("Este Detalle de Linea ya existe. Intente Ingresar otro Detalle..");
			 window.location="http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmLineaDetNuevo.php";
			 </script>';
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmLineaDetNuevo.php");
                            }
         }
        ...
        elseif ($var==2){
                ...
                $codigo=0;
                $var=0;
                header("Refresh:0; url=http://aplicaciones.intn.gov.py/web/phpsueldos2016/userloget/FrmLineaDetModif.php");
            }
       //
        ?>
    </body>
