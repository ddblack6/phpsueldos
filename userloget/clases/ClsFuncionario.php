          ...
          $database = 'salario';
           ...
           if ($var==1){
			...
			alert("El Funcionario ya existe. Intente Ingresar otro Funcionario..");
			 window.location="http://localhost/app/phpsueldosuserloget/FrmFuncionarioNuevo.php";
			 </script>';
                      }else{              
                            //se define el Query   
                            ...
                            $query = '';
                            $var=0;
                            header("Refresh:0; url=http://localhost/app/phpsueldosuserloget/FrmFuncionarioNuevo.php");
                            }
         }
