...
$str_conexao='dbname=contabilidade port=5432 user=postgres password=postgres_server';
...
$connection_string = 'dbname=salario port=5432 user=postgres password=postgres_server';
