...
case 'oci8po':
	...
	$db->Connect('192.168.0.99','scott','natsoft','sherkhan');
	break;
default:
case 'mysql':
	$db = NewADOConnection("mysql");
	$db->Connect('192.168.0.99','root','','northwind');
	break;

case 'mysqli':
	$db = NewADOConnection("mysqli://root:@192.168.0.99/northwind");
	//$db->Connect('192.168.0.99','root','','test');
	break;
}
} catch (exception $e){
	echo "Connect Failed";
